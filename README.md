...
1.  Choose how to deploy:
    ...
    c. Using a prebuilt docker image:

    - [quay.io/pusher/oauth2_proxy](https://quay.io/pusher/oauth2_proxy) (amd64)
    - [quay.io/pusher/oauth2_proxy-armv6](https://quay.io/pusher/oauth2_proxy-armv6) (armv6)
    - [quay.io/pusher/oauth2_proxy-arm64](https://quay.io/pusher/oauth2_proxy-arm64) (arm64)
